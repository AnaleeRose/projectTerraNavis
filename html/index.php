...
<article id="mainContent">
    ...
    <section id="mainpg-sec1">
        <h2 class="sec-title">What is an Earthship?</h2>
        <div class="sec-content">
            ...
            <a class="readMore_home">Visit Our FAQ</a>
        </div>
    </section>
    ​
    <section id="mainpg-sec2">
        <h2 class="sec-title">Sustainable Living</h2>
        <div class="sec-content">
            ...
            <a class="readMore_home">Learn More About Sustainable Living</a>
        </div>
    </section>
    ​
    <section id="mainpg-sec3">
        ...
        <div class="sec-content">
            ...
            <a class="readMore_home">Learn More About Building Earthships</a>
        </div>
    </section>
</article>
